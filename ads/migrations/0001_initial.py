# Generated by Django 5.2.1 on 2025-05-26 03:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ожидает', 'Ожидает'), ('принята', 'Принята'), ('отклонена', 'Отклонена')], default='ожидает', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
